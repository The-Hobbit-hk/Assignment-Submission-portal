...
export function VentOutSection() {
  return (
    ...
    >
      <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 lg:grid-cols-2 lg:gap-12 lg:px-8">
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
          ...
          <p className="mt-4 max-w-sm text-sm text-[#4f6b4a]">
            {VENT_OUT_2_ME.closing}
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <p className="text-sm leading-relaxed text-zinc-600">
            {VENT_OUT_2_ME.support}
          </p>

          <div className="rounded-2xl border border-emerald-900/10 bg-white/80 p-5 sm:p-6">
            <div className="flex items-start gap-3">
              <HeartHandshake
                className="mt-0.5 h-5 w-5 shrink-0 text-[#4f6b4a]"
                aria-hidden
              />
              <div>
                <h3 className="font-semibold text-zinc-900">
                  {VENT_OUT_2_ME.stepsHeading}
                </h3>
