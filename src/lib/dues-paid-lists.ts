...
export const DUES_PAID_LISTS: ClubDuesPaidList[] = [
  ...
  {
    clubName: "Rotaract Club of Genba Sopanrao Moze College of Engineering",
    clubCharterId: "8826700",
    members: [
      { name: "Mohammad Rehan Khan", riId: "12678475" },
      { name: "Saksham Wadekar", riId: "12682200" },
      { name: "Shrawani Shendkar", riId: "12178897" },
      { name: "Shivraj Balasaheb Surwase", riId: "12181756" },
      { name: "Sarvesh Gavali", riId: "12616241" },
      { name: "Monika Shrikant Dukare", riId: "12685979" },
      { name: "Shruti Devendar Ettam", riId: "12613245" },
      { name: "Premsingh Rajput", riId: "12632426" },
      { name: "Prathamesh Ramesh Gopale", riId: "12684822" },
      { name: "Sanchit Sagar Jadhav", riId: "12684811" },
      { name: "Viraj Kaluram Pawar", riId: "12684864" },
      { name: "Viraj Vikas Narsale", riId: "12396970" },
      { name: "Parth Dube", riId: "12679188" },
      { name: "Vedant Kumbhar", riId: "12679789" },
      { name: "Shubham Balnath Sarade", riId: "12684870" },
      { name: "Aditi Shelar", riId: "12679578" },
      { name: "Rajeshwari Shankar Chavan", riId: "12678481" },
      { name: "Atharva Khot", riId: "12501367" },
      { name: "Himanshu Mahesh Khadke", riId: "12679667" },
      { name: "Vedika Gajanan Kotalwar", riId: "12682286" },
      { name: "Ananya Bodhe", riId: "12550039" },
    ],
  },
  {
    clubName: "Rotaract Club of Panvel Central",
    clubCharterId: "214399",
    members: [
      { name: "Omkar Ravindra Shahsane", riId: "11908537" },
      { name: "Vyas Manoj Angre", riId: "12596828" },
      { name: "Aishwarya Anil Khandekar", riId: "12596835" },
      { name: "Aditya Vikram Kaiya", riId: "12596843" },
      { name: "Dignesh Satyavan Bhoir", riId: "10899101" },
      { name: "Pratham Sandeep Chinte", riId: "12674054" },
      { name: "Aisiri Pritam Kaiya", riId: "12673934" },
      { name: "Om Umesh Tikhile", riId: "12676739" },
      { name: "Aastha Avinash Chavan", riId: "12733069" },
      { name: "Dipesh Anil Khandekar", riId: "12596844" },
      { name: "Manan Mihir Dedhia", riId: "12596850" },
      { name: "Ishita Sudip Gaikwad", riId: "12676935" },
      { name: "Kavya Amar Surve", riId: "12596858" },
      { name: "Devesh Savlesa", riId: "12684788" },
      { name: "Yash Kaustubh Gudag", riId: "12596855" },
    ],
  },
  {
    clubName: "Rotaract Club of Pune Shaniwarwada",
    clubCharterId: "45125",
    members: [
      { name: "Aishwarya Musale", riId: "11929005" },
      { name: "Kanika Jha", riId: "12411781" },
      { name: "Harshwardhan Memane", riId: "12627158" },
      { name: "Aishwarya Patil", riId: "11492286" },
      { name: "Sakshi Patange", riId: "12495566" },
      { name: "Saket Khodaskar", riId: "11159352" },
      { name: "Purva Valsange", riId: "12696173" },
      { name: "Faizan Tamboli", riId: "9732322" },
      { name: "Puskar Tare", riId: "11817828" },
      { name: "Suraj Surkutla", riId: "10786128" },
      { name: "Madhu Pimprikar", riId: "11047915" },
      { name: "Ameya Mhaske", riId: "10781823" },
      { name: "Simran Chhetri", riId: "12689687" },
      { name: "Mateen Jamadar", riId: "12644766" },
      { name: "Sanika Malve", riId: "11499800" },
      // Sheet note: Karishma added but has not paid club dues — omitted.
    ],
  },
  {
    clubName: "Rotaract Club of Pune City Fortune",
    clubCharterId: "8823957",
    members: [
      { name: "Prathmesh Manjare", riId: "12344397" },
      { name: "Miheeka Khair", riId: "12344636" },
      { name: "Purva Jadhav", riId: "11891388" },
      { name: "Piyusha Patil", riId: "11891371" },
      { name: "Vidhi Lunawat", riId: "12630585" },
      { name: "Sanjyot Khopade", riId: "12444478" },
      { name: "Mihir Bhamare", riId: "11311517" },
      { name: "Vaibhav Deshpande", riId: "10316558" },
      { name: "Aditi Aundhkar", riId: "12154130" },
      { name: "Anuj Mogal", riId: "12630686" },
      { name: "Harshal Ramani", riId: "12630722" },
      { name: "Siddhant Rothe", riId: "12683593" },
      { name: "Jayesh Chavan", riId: "12224980" },
      { name: "Aishwarya Chavan", riId: "12515549" },
      { name: "Shivam Shende", riId: "12353682" },
      { name: "Rajas Uchgaonkar", riId: "11303190" },
      { name: "Omkar Patil", riId: "11891333" },
      { name: "Waman Jahgirdar", riId: "9945803" },
      { name: "Vipul Sonawane", riId: "12105274" },
      { name: "Digvijay Lad", riId: "11751959" },
      { name: "Akash Bhandare", riId: "11311304" },
      { name: "Yash Zumbre", riId: "12149869" },
      { name: "Shreya Nyati", riId: "12709590" },
      { name: "Devendra More", riId: "12733049" },
    ],
  },
  {
    clubName: "Rotaract Club of Poona South",
    clubCharterId: "7283",
    members: [
      { name: "Yash Milind Dandekar", riId: "12682532" },
      { name: "Rajvardhan Ramchandra Patil", riId: "12714964" },
      { name: "Kartik Mahesh Bhapkar", riId: "12608158" },
      { name: "Vrinda Tanaji Sutar", riId: "12611588" },
      { name: "Shubham Prabodh Patil", riId: "12681079" },
      { name: "Aryan Devne", riId: "11838655" },
      { name: "Bhargavee Mhatre", riId: "12714974" },
      { name: "Om Shete", riId: "12714976" },
      { name: "Grishma Shinde" },
      { name: "Padmakar Nikam", riId: "12714988" },
      { name: "Sanskar Sachin Redekar", riId: "12714991" },
      { name: "Yashswini Mane" },
      { name: "Aastha Patil" },
      { name: "Prasad Patil", riId: "11215956" },
      { name: "Aditya Shreyeskar" },
      { name: "Rishi Ravindra Sangar" },
      { name: "Riddhi Porwal" },
      { name: "Shardul Chakankar" },
      { name: "Darshana Gandhi" },
    ],
  },
  {
    clubName: "Rotaract Club of Pune Baner",
    clubCharterId: "8825923",
    members: [
      { name: "Sanika Luktuke", riId: "12580864" },
      { name: "Arnav Gupta", riId: "12638165" },
      { name: "Ariv Upadhyaya", riId: "12638158" },
      { name: "Ameya Borkar", riId: "12638128" },
      { name: "Veer Batra", riId: "12638680" },
      { name: "Yash Dhana", riId: "12635717" },
      { name: "Ishan Gite", riId: "12586850" },
      { name: "Aastha Konda", riId: "11847252" },
      { name: "Kareena Karfa", riId: "12638858" },
      { name: "Srushti Arawandekar", riId: "11897776" },
      { name: "Kuhoo Khandekar", riId: "12653947" },
      { name: "Aryan Khatri", riId: "12729278" },
      { name: "Daiwik Karfa", riId: "11866080" },
      { name: "Pradhyumna Lunkad", riId: "12580998" },
      { name: "Utkarsh Deshmukh", riId: "12729404" },
      { name: "Chinmay Palgaonkar", riId: "12729321" },
      { name: "Mounika Uppaladadium", riId: "10761587" },
    ],
  },
  {
    clubName: "Rotaract Club of Koregaon Park",
    clubCharterId: "215663",
    members: [
      { name: "Aaquib Shaikh", riId: "12192493" },
      { name: "Anish Sampson", riId: "12192490" },
      { name: "Chirag Pattewar", riId: "12214465" },
      { name: "Devyani Rao", riId: "12192503" },
      { name: "Harsh Gundecha", riId: "12145172" },
      { name: "Ibrahim Poonawala", riId: "12498908" },
      { name: "Keya Shah", riId: "12145179" },
      { name: "Kruttika Doiphode", riId: "12192500" },
      { name: "Mariya Bhagat", riId: "12500700" },
      { name: "Purva Agarwal", riId: "12499707" },
      { name: "Rohan Tejwani", riId: "12498808" },
      { name: "Saket Singh", riId: "11241868" },
      { name: "Snehi Kotak", riId: "12192494" },
      { name: "Yash Munot", riId: "12192445" },
      { name: "Yukta Shroff", riId: "12498826" },
    ],
  },
  {
    clubName: "Rotaract Club of Vibrants",
    clubCharterId: "214094",
    members: [
      { name: "Aditya Jachak", riId: "11857517" },
      { name: "Dhruv Mirajkar", riId: "12418829" },
      { name: "Abhishek Sachchidanand Dixit", riId: "12401193" },
      { name: "Swanand Kulkarni", riId: "12228123" },
      { name: "Mohit Narendra Kirtane", riId: "12189973" },
      { name: "Nidhi Kulkarni", riId: "12418827" },
      { name: "Poorva Parag Takle", riId: "12190369" },
      { name: "Shravni Garde", riId: "12216734" },
      { name: "Sanjana Pawar", riId: "11641713" },
      { name: "Lakshanya Pawar", riId: "11641721" },
      { name: "Ayush Malpe", riId: "12498331" },
      { name: "Ishan Malawade", riId: "11310222" },
      { name: "Pranit Panse", riId: "11857532" },
      { name: "Sanika Jayant Ansingkar", riId: "12488033" },
      { name: "Bhakti Chaudhari", riId: "12714966" },
    ],
  },
  {
    clubName: "Rotaract Club of Konkan Gyanpeeth Rahul Dharkar College Of Pharmacy Karjat",
    clubCharterId: "8825261",
    members: [
      { name: "Aditya Adalinge", riId: "12362486" },
      { name: "Harshali Pandurang Kalape", riId: "12405523" },
      { name: "Tushar Dashrath Ghare", riId: "12633144" },
      { name: "Harshala Pramod Kurle", riId: "12239553" },
      { name: "Prince Koli", riId: "12343529" },
      { name: "Shlok Mahesh Borhade", riId: "12106616" },
      { name: "Tanushka Bhusari", riId: "12633184" },
      { name: "Kajal Ashok Gharate", riId: "12506210" },
      { name: "Love Shahaji Pawar", riId: "12637379" },
      { name: "Dhruvi Ashish Raicha", riId: "12599843" },
      { name: "Shrushti Pawar", riId: "12623723" },
      { name: "Rujuta Sudhir Sawant", riId: "12623691" },
      { name: "Pratham Dinesh Babariya", riId: "12629464" },
      { name: "Yashodhana Chouhan", riId: "12633104" },
      { name: "Durvesh Santosh Chavan", riId: "12344082" },
      { name: "Sakshi Naresh Lad", riId: "12632766" },
    ],
  },
];
