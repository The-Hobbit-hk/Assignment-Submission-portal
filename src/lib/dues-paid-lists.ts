...
export const DUES_PAID_LISTS: ClubDuesPaidList[] = [
  ...
  {
    clubName: "Rotaract Club of Pune City Legends",
    clubCharterId: "8826615",
    members: [
      { name: "Shreya Kotkar", riId: "12135355" },
      { name: "Amrisha Gamane", riId: "12658301" },
      { name: "Aryan Kudale", riId: "11892579" },
      { name: "Rohit Thakare", riId: "12704591" },
      { name: "Samruddhi Desale", riId: "12703034" },
      { name: "Shruti Khedkar", riId: "12459695" },
      { name: "Asawari Nikam", riId: "12698904" },
      { name: "Arya Kalambe", riId: "12698729" },
      { name: "Prajakta Navtakke", riId: "11528094" },
      { name: "Shamal Dandgavhal", riId: "12702394" },
      { name: "Atharv Yadav", riId: "11892750" },
      { name: "Prassana Tayade", riId: "12696241" },
      { name: "Mohit Teke", riId: "12113514" },
      { name: "Pratiksha Shinde", riId: "12709429" },
      { name: "Akash Patil", riId: "11892717" },
      { name: "Vedant Raykar", riId: "11893323" },
    ],
  },
  {
    clubName: "Rotaract Club of Ajeenkya DY Patil Group",
    clubCharterId: "8826992",
    members: [
      { name: "Abhijeet Shinde", riId: "12271293" },
      { name: "Aditya Sharma", riId: "12270981" },
      { name: "Gaurav Talekar", riId: "12675451" },
      { name: "Aayan Parkar", riId: "12581895" },
      { name: "Om Jeughale", riId: "12271403" },
      { name: "Ankesh Arya", riId: "12581909" },
      { name: "Zainab Shaikh", riId: "12675559" },
      { name: "Sakina Vohra", riId: "12675321" },
      { name: "Charan Lokala Nagakarthik", riId: "12581894" },
      { name: "Nandini Sharma", riId: "12636490" },
      { name: "Rakhi Bayas", riId: "12611824" },
      { name: "Yash Somani", riId: "12271399" },
      { name: "Manav Khandelwal", riId: "12702481" },
      { name: "Krishna Upadhyay", riId: "12691709" },
      { name: "Harkesh Raghavan", riId: "12709823" },
    ],
  },
  {
    clubName: "Rotaract Club of Pune Cantonment",
    clubCharterId: "212790",
    members: [
      { name: "Yash Wadhwani" },
      { name: "Dishank Shah" },
      { name: "Abdullah Hiroli" },
      { name: "Amaan Hussain" },
      { name: "Fatema Kamdar" },
      { name: "Taher Vasowala" },
      { name: "Krishna Budhani" },
      { name: "Janhavi Archanan Shede" },
      { name: "Tanay Telang" },
      { name: "Ananya Jadhav" },
      { name: "Yash Jadhav" },
      { name: "Sarah Khan" },
      { name: "Albaz Shaikh" },
      { name: "Heet Gautam Patel" },
      { name: "Yashika Bhati" },
      { name: "Huzefa Kachwal" },
    ],
  },
  {
    clubName: "Rotaract Club of Universal AI University",
    clubCharterId: "8826658",
    members: [
      { name: "Saikat Mishra", riId: "12406493" },
      { name: "Sristi Chatterjee", riId: "12406516" },
      { name: "Nikhil Verma", riId: "12406518" },
      { name: "Hiranmayee Iyer", riId: "12713819" },
      { name: "Naman Ruhela", riId: "12690452" },
      { name: "Rahul Choubey", riId: "12406500" },
      { name: "Asmi Wagde", riId: "12406517" },
      { name: "Bipasa Roy", riId: "12690463" },
      { name: "Kushagra Sharma", riId: "12690456" },
      { name: "Mahi Vashisht", riId: "12406506" },
      { name: "Vratika Jain", riId: "12406512" },
      { name: "Anshika Sharma", riId: "12690458" },
      { name: "Satyam Agrawal", riId: "12690449" },
      { name: "Shesh Tiwari", riId: "12690461" },
      { name: "Harshit Jain", riId: "12690451" },
      { name: "Nishtha Patidar", riId: "12713821" },
      { name: "Aditi Gurnani", riId: "12690457" },
      { name: "Khushi Pareek", riId: "12690460" },
      { name: "Mridhu Joshi", riId: "12690454" },
      { name: "Isha Verma", riId: "12690474" },
      { name: "Riyas Mukherjee", riId: "12690455" },
      { name: "Piyush Thakkar", riId: "12406459" },
      { name: "Riddhi Jain", riId: "12690464" },
      { name: "Manav Chomal", riId: "12406509" },
      { name: "Siddharoodh Biradar", riId: "12690453" },
      { name: "Sarang Manekar", riId: "12690466" },
      { name: "Khushii Engineer", riId: "12690470" },
      { name: "Bhagya Ajith", riId: "12406498" },
      { name: "Dhrubajeet Mondal", riId: "12690471" },
      { name: "Rishav Anand", riId: "12406508" },
      { name: "Arnab Das", riId: "12406505" },
      { name: "Aman Pawar", riId: "12690473" },
      { name: "Bindia Rani", riId: "12406520" },
      { name: "Truptimayee Rout", riId: "12406523" },
      { name: "Anubhuti Singh", riId: "12406497" },
    ],
  },
  {
    // Sheet RI IDs were truncated; match by name.
    clubName: "Rotaract Club of Pune Royal",
    clubCharterId: "214473",
    members: [
      { name: "Roma Devadhar" },
      { name: "Swarada Mhetre" },
      { name: "Ashwineeya Raut" },
      { name: "Hetvi Patel" },
      { name: "Anika Oturkar" },
      { name: "Harshita Ghate" },
      { name: "Sushrut Waghmare" },
      { name: "Umang Gharpure" },
      { name: "Aarya More" },
      { name: "Kshitij Pharande" },
      { name: "Yash Lonkar" },
      { name: "Siddhant Narwade" },
      { name: "Suru Chabukswar" },
      { name: "Sanjana Sathe" },
    ],
  },
  {
    clubName: "Rotaract Club of Pune Zenith",
    clubCharterId: "217271",
    members: [
      { name: "Atharv Khatkhate", riId: "12210577" },
      { name: "Janhavi Yeole", riId: "11889397" },
      { name: "Adhishree Thakar", riId: "10705054" },
      { name: "Samrudhi Khade", riId: "11598405" },
      { name: "Srushti Gavali", riId: "12412484" },
      { name: "Manas Yeole" },
      { name: "Gayatri Dinkar", riId: "11599257" },
      { name: "Neeraj Chandratre", riId: "12412395" },
      { name: "Aishwarya Khade", riId: "10279670" },
      { name: "Hitarth Joshi", riId: "12123557" },
      { name: "Samruddhi Kulkarni", riId: "11993942" },
      { name: "Aarya Tamankar", riId: "12734386" },
      { name: "Shrivatsa Summant", riId: "12444391" },
      { name: "Rutuja Shinde", riId: "12734349" },
      { name: "Anuj Narkar", riId: "12729837" },
    ],
  },
];
