...
export default function ExportEventsPage() {
  ...
  return (
    <div className="mx-auto max-w-lg space-y-6">
      <PageHeading
        title="Export Event Reports"
        subtitle={`Download all club event reporting data for ${getReportingPeriodLabel(month, year)}.`}
      />
      <Button asChild className="bg-accent text-accent-foreground">
        <a href={`/api/reporting/export/events?month=${month}&year=${year}`} download>
